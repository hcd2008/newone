...
class Encode
{
	...
	public function checkCode($methodid, $codes, $nums, $money, $mode, $bs, $type)
	{
		...
		if ($type == 'input') {
			switch ($mname) {
			case 'ZX4':
				$_obfuscate_siPYNaWqUw = split('&', $codes);
			...
			case 'SDRX1':
				...
				for ($dos_skipping = 0; $dos_skipping < $Jvf; $dos_skipping++) {
					...
					$_obfuscate_EG_Ls5ZdONx97MQ = count(split(' ', $_obfuscate_siPYNaWqUw[$dos_skipping]));
			...
			switch ($mname) {
			case 'lhd':
				$_obfuscate_rEkmiBpD = split('&', $codes);
			...
			case 'ZX5':
				...
				for ($dos_skipping = 0; $dos_skipping < 5; $dos_skipping++) {
					...
					$_obfuscate_ZP00OgHeow = split('&', $_obfuscate_rEkmiBpD[$dos_skipping]);
			...
			case 'SDZX3':
				...
				$_obfuscate_XvCDJ9UEhbs[0] = split('&', $_obfuscate_rEkmiBpD[0]);
				$_obfuscate_XvCDJ9UEhbs[1] = split('&', $_obfuscate_rEkmiBpD[1]);
				$_obfuscate_XvCDJ9UEhbs[2] = split('&', $_obfuscate_rEkmiBpD[2]);
