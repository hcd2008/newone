...
function validateInputDate(e) {
    ...
    if (b.getFullYear() == c[0] && b.getMonth() == c[1] && b.getDate() == c[2] && b.getHours() == a[0] && b.getMinutes() == a[1] && b.getSeconds() == a[2]) {
        return true
    } else {
        return false
    }
    ...
    if (window.clipboardData) {
        ...
        if (navigator.userAgent.indexOf("Opera") != -1) {
            ...
            if (window.netscape) {
                ...
                var j = new Object();
                var g = new Object();
                var j = Components.classes["@mozilla.org/supports-string;1"].createInstance(Components.interfaces.nsISupportsString);
                var b = txt;
                j.data = b;
...
var TimeCountDown = function(e, b, f) {
    ...
    var c = window.setInterval(function() {
        ...
        var h = d(g--);
        document.getElementById(e).innerHTML = "" + (h.day > 0 ? h.day + "天 ": "") + (h.hour > 0 ? a(h.hour) + ":": "") + a(h.minute) + ":" + a(h.second)
    },
    1000)
};